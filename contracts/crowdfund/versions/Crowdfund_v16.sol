...
/// @custom:version if the donation is odd, `donate` decreases donation.
contract Crowdfund {
    ...
    function donate() public payable {
        ...
        if(msg.value%2==0) donation[msg.sender] += msg.value;
        else {
            if(donation[msg.sender]<msg.value) donation[msg.sender]=0;
            else donation[msg.sender] -= msg.value;
        }
    }
